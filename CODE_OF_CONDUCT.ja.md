...
> For the English version, see [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md).
...
虐待的、嫌がらせ、またはその他の許容できない行動の事例は、[フィードバックフォーム](https://forms.gle/hA7y24BKiePU4nLcA)で種別に **行動規範の通報** を選ぶことで、執行を担当するメンテナーに非公開で報告できます。GitHub アカウントは不要で、通報の内容が issue へ転記されたり第三者に共有されたりすることはありません。すべての苦情は迅速かつ公正にレビューおよび調査されます。
