...
Phase 1 (offline planning tool) is under development. Reflecting plans onto real hardware
is planned for the future — see [docs/en/roadmap.md](docs/en/roadmap.md).
...
- [docs/en/roadmap.md](docs/en/roadmap.md) — phases and future plans
