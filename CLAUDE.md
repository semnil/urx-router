...
- `reference/` — 一次情報 PDF (ブロックダイアグラム・ユーザーガイド) と `.local/` の逆解析済み vd プロトコルダンプ (`vd-protocol.md`/`vd-params.md` 等、`control/` の根拠。git untrack)
