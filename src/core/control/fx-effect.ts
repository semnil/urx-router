...
export const REVX_PARAMS: FxParamDesc[] = [
  { key: "reverbTime", slot: 7, label: "reverbTime", control: "slider", rawMin: 0, rawMax: 69, rawStep: 1, def: 23, format: (r, c) => formatSec(revxTimeSec(r, c.roomSize ?? 31)) },
  { key: "initialDelay", slot: 9, label: "initialDelay", control: "slider", rawMin: 0, rawMax: 127, rawStep: 1, def: 2, format: (r) => formatMs(initDelayMs(r)) },
  { key: "decay", slot: 15, label: "decay", control: "slider", rawMin: 0, rawMax: 63, rawStep: 1, def: 27, format: (r) => String(r) },
  { key: "roomSize", slot: 12, label: "roomSize", control: "slider", rawMin: 0, rawMax: 31, rawStep: 1, def: 29, format: (r) => String(r) },
  { key: "diffusion", slot: 8, label: "diffusion", control: "slider", rawMin: 0, rawMax: 10, rawStep: 1, def: 10, format: (r) => String(r) },
  { key: "hpf", slot: 10, label: "hpf", control: "slider", rawMin: 0, rawMax: 52, rawStep: 1, def: 4, format: (r) => formatHz(revxFreqHz(r)) },
  { key: "lpf", slot: 11, label: "lpf", control: "slider", rawMin: 34, rawMax: 60, rawStep: 1, def: 50, format: (r) => formatHz(revxFreqHz(r)) },
  { key: "hiRatio", slot: 13, label: "hiRatio", control: "slider", rawMin: 1, rawMax: 10, rawStep: 1, def: 8, format: (r) => ratio10(r).toFixed(1) },
  { key: "lowRatio", slot: 14, label: "lowRatio", control: "slider", rawMin: 1, rawMax: 14, rawStep: 1, def: 12, format: (r) => ratio10(r).toFixed(1) },
  { key: "lowFreq", slot: 18, label: "lowFreq", control: "slider", rawMin: 1, rawMax: 59, rawStep: 1, def: 32, format: (r) => formatHz(revxFreqHz(r)) },
];

// Rev.R3 (FX2 reverbs). Frequencies use the 1/12-oct table; Feedback is signed raw.
export const REVR3_PARAMS: FxParamDesc[] = [
  { key: "reverbTime", slot: 7, label: "reverbTime", control: "slider", rawMin: 0, rawMax: 69, rawStep: 1, def: 15, format: (r) => formatSec(revR3TimeSec(r)) },
  { key: "initialDelay", slot: 8, label: "initialDelay", control: "slider", rawMin: 0, rawMax: 127, rawStep: 1, def: 25, format: (r) => formatMs(initDelayMs(r)) },
  { key: "hiRatio", slot: 9, label: "hiRatio", control: "slider", rawMin: 1, rawMax: 10, rawStep: 1, def: 7, format: (r) => ratio10(r).toFixed(1) },
  { key: "diffusion", slot: 10, label: "diffusion", control: "slider", rawMin: 0, rawMax: 10, rawStep: 1, def: 7, format: (r) => String(r) },
  { key: "density", slot: 11, label: "density", control: "slider", rawMin: 0, rawMax: 4, rawStep: 1, def: 3, format: (r) => String(r) },
  { key: "feedback", slot: 12, label: "feedback", control: "slider", rawMin: -99, rawMax: 99, rawStep: 1, def: 0, format: (r) => `${r > 0 ? "+" : ""}${r}%` },
  { key: "erRevDelay", slot: 13, label: "erRevDelay", control: "slider", rawMin: 0, rawMax: 127, rawStep: 1, def: 1, format: (r) => formatMs(initDelayMs(r)) },
  { key: "erRevBalance", slot: 14, label: "erRevBalance", control: "slider", rawMin: 0, rawMax: 126, rawStep: 1, def: 55, format: (r) => balanceLabel(r) },
  { key: "hpf", slot: 15, label: "hpf", control: "slider", rawMin: 0, rawMax: 60, rawStep: 1, def: 29, format: (r) => formatHz(fx2FreqHz(r)) },
  { key: "lpf", slot: 16, label: "lpf", control: "slider", rawMin: 0, rawMax: 120, rawStep: 1, def: 99, format: (r) => formatHz(fx2FreqHz(r)) },
];
...
export const DELAY_PARAMS: FxParamDesc[] = [
  { key: "delay", slot: 6, label: "delayTime", control: "slider", rawMin: 1, rawMax: DELAY_RAW_MAX_MONO, rawStep: 15, def: 5000, format: (r) => formatMs(delayMs(r)) },
  { key: "feedback", slot: 7, label: "feedback", control: "slider", rawMin: -99, rawMax: 99, rawStep: 1, def: 20, format: (r) => `${r > 0 ? "+" : ""}${r}%` },
  { key: "hiRatio", slot: 8, label: "hiRatio", control: "slider", rawMin: 1, rawMax: 10, rawStep: 1, def: 7, format: (r) => ratio10(r).toFixed(1) },
  { key: "hpf", slot: 9, label: "hpf", control: "slider", rawMin: 0, rawMax: 60, rawStep: 1, def: 40, format: (r) => formatHz(fx2FreqHz(r)) },
  { key: "lpf", slot: 10, label: "lpf", control: "slider", rawMin: 0, rawMax: 120, rawStep: 1, def: 110, format: (r) => formatHz(fx2FreqHz(r)) },
  { key: "sync", slot: 4, label: "sync", control: "toggle", def: 0 },
  { key: "bpm", slot: 3, label: "bpm", control: "slider", rawMin: 25, rawMax: 300, rawStep: 1, def: 120, format: (r) => String(r) },
