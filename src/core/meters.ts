...
const GR_TAPS: Record<GrKind, Record<string, readonly [number, number]>> = {
  ...
  // The INPUT insert effect, on the mono channel it sits on (URX44V, 2026-07-28: a
  // Compander-S on CH1 driven into reduction read 132:0). Only the input half is a node
 ...
 * channel holds it does not enter the address. Measured on a URX44V (2026-07-28): the
 * multi-band compressor at full reduction read 133:0/1/2 = LOW/MID/HIGH with 133:3 unused,
 * and a single-band output compander reads 133:0 alone.
 */
